...
{{#include ./_getQCAssignmentMax-Reference.md:function}}

## Description

{{#include ./_getQCAssignmentMax-Reference.md:description}}

## Arguments

{{#include ./_getQCAssignmentMax-Reference.md:arguments}}

## Return Values

{{#include ./_getQCAssignmentMax-Reference.md:return-values}}

## Example

{{#include ./_getQCAssignmentMax-Reference.md:example}}
