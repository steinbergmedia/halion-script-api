...
{{#include ./_getQCAssignmentScope-Reference.md:function}}

## Description

{{#include ./_getQCAssignmentScope-Reference.md:description}}

## Arguments

{{#include ./_getQCAssignmentScope-Reference.md:arguments}}

## Return Values

{{#include ./_getQCAssignmentScope-Reference.md:return-values}}

## Example

{{#include ./_getQCAssignmentScope-Reference.md:example}}
