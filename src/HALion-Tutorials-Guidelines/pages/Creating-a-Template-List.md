...
1. Select the BasicList item, go to the **Properties** editor and set the Name template parameter to '@RowNames'. The list entries you defined in step 9 should now display with the look you defined in step 4.
