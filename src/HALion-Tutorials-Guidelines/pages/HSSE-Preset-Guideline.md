...
* You can assign insert effects to the layers and the program on the Inserts tab in HALion Sonic 3. Please do not use any AUX effects, because they are not saved with Program presets.
