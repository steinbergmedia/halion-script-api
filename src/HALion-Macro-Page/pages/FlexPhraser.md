...
2. Open the **Macro Page Designer**, go to the **GUI Tree** and navigate to "Pages > FlexPhraser Page". 
3. Select "Arp Parameter" and click **Edit Element** ![Edit Element](../images/EditElement.PNG) to examine the template.
