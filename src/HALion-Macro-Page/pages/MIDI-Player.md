...
|:-|:-|:-|
|1|<p>**Product** = ``HALion``</p><p>**Load From** = ``StepSEQ Phrases``</p>|Only phrases from HALion, including any phrases the user has saved on hard disk.|
|2|<p>**Product** = ``MyProductName``</p><p>**Load From** = ``StepSEQ Phrases``</p>|Only phrsaved with the instrument on hard disk.|
|3|<p>**Product** = ``MyProductName``&vert;``HALion``</p><p>**Load From** = ``StepSEQ Phrases``</p>|All phrases from HALion, the specified library and any phrases the user has saved on hard disk.|
