...
|**Loop Marker**|Activate this option to show loop markers as flags instead of overlay rectangles.|
|**Editable**|Activate this option to make markers editable. The responsive editing area for markers depends on whether the Grain Pos parameter is connected. I Grain Pos is enabled, you can drag only the bottom of the marker (20 pixels). This is to avoid conflicts with the Grain Position marker which uses the rest of the display. Otherwise, markers can be dragged along their entire length.|
...
|**Play Pos**|Allows you to connect the PlayPos parameter of the sample oscillator. This will display a locator for the sample playback. If you are using a Grain or Spectral zone, you must connect this to the PlayData parameter of the grain or spectral oscillator instead. This will display a locator for each playing grain or each spectral multi-voice.|
|**Grain Pos**|Allows you to connect the Position parameter of the grain or spectral oscillator. This will display a locator for each playing grain or each spectral multi-voice. The locators only work if PlayPos is connected, too.|
...
|**Fade In L**|Allows you to connect the FadeInLength parameter of the sample oscillator. This is required if you want to display the influence of a fade in.|
|**Fade In C**|Allows you to connect the FadeInCurve parameter of the sample oscillator. This is required if you want to display the influence of a fade in.|
|**Fade Out L**|Allows you to connect the FadeOutLength parameter of the sample oscillator. This is required if you want to display the influence of a fade out.|
|**Fade Out C**|Allows you to connect the FadeOutCurve parameter of the sample oscillator. This is required if you want to display the influence of a fade out.|
|**Play Mode**|Allows you to connect the PlaybackMode parameter of the sample oscillator. This is required if you want to display the influence of the playback mode. Otherwise, the sample will never be shown reversed.|
|**Level Env**|Allows you to connect the LevelEnvelope parameter of the sample oscillator. This is required if you want to display the influence of a level envelope.|
...
|**RelStart**|The color of the release start marker.|
